...
<body>
    ...
    <main class="main" id="top">
        <div class="container" data-layout="container">
            ...
            <div class="row flex-center min-vh-100 py-6 text-center">
                <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4"><a
                        class="d-flex flex-center mb-4 text-primary" href="<?php echo base_url();?>"><img class="me-2"
                            src="<?php echo base_url();?>assets/assets/img/icons/spot-illustrations/debiconta.png"
                            alt="" width="58" /><span class="font-sans-serif fw-bolder fs-5 d-inline-block"><?php echo lang('App.general.empresa');?></span></a>
                    <div class="card">
                        <div class="card-body p-4 p-sm-5">
                            <div class="fw-black lh-1 text-300 fs-error">404</div>
                            <p class="lead mt-4 text-800 font-sans-serif fw-semi-bold w-md-75 w-xl-100 mx-auto"><?php echo lang('Error.404.titulo');?></p>
                            <hr />
                            <p> <?php echo lang('Error.404.descripcion');?> <a href="mailto:<?php echo lang('App.general.correo');?>"
                                    class="text-primary"><?php echo lang('Error.404.contactanos');?></a>.</p><a class="btn btn-primary btn-sm mt-3"
                                href="<?php echo base_url();?>"><span class="fas fa-home me-2"></span><?php echo lang('Error.404.regresar');?></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="offcanvas-header settings-panel-header bg-shape">
        <div class="z-1 py-1" data-bs-theme="light">
            <div class="d-flex justify-content-between align-items-center mb-1">
                <h5 class="text-white mb-0 me-2"><span
                        class="fas fa-palette me-2 fs-0"></span><?php echo lang('App.personalizacion.cabecera.config');?>
                </h5>
                <button class="btn btn-primary btn-sm rounded-pill mt-0 mb-0" data-theme-control="reset"
                    style="font-size:12px"> <span class="fas fa-redo-alt me-1"
                        data-fa-transform="shrink-3"></span><?php echo lang('App.personalizacion.cabecera.reiniciar');?></button>
            </div>
            <p class="mb-0 fs--1 text-white opacity-75"><?php echo lang('App.personalizacion.cabecera.descripcion');?>
            </p>
        </div>
    ...
    <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight"> <span
                            class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                src="<?php echo base_url();?>assets/assets/img/generic/falcon-mode-default.jpg"
                                alt="" /></span><span
                            class="label-text"><?php echo lang('App.personalizacion.esquema.claro');?></span></label>
                </div>
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span
                            class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                src="<?php echo base_url();?>assets/assets/img/generic/falcon-mode-dark.jpg"
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-start"><img class="me-2"
                    src="<?php echo base_url();?>assets/assets/img/icons/left-arrow-from-left.svg" width="20" alt="" />
                <div class="flex-1">
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-start"><img class="me-2"
                    src="<?php echo base_url();?>assets/assets/img/icons/arrows-h.svg" width="20" alt="" />
                <div class="flex-1">
            ...
            <div class="row gx-2">
                <div class="col-6">
                    ...
                    <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent"> <img
                            ...
                            src="<?php echo base_url();?>assets/assets/img/generic/default.png" alt="" /><span
                            class="label-text">
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted"> <img
                            class="img-fluid img-prototype"
                            src="<?php echo base_url();?>assets/assets/img/generic/inverted.png" alt="" /><span
                            class="label-text"> <?php echo lang('App.personalizacion.estilo.oscuro');?></span></label>
                </div>
                <div class="col-6">
                    ...
                    <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card"> <img
                            class="img-fluid img-prototype"
                            src="<?php echo base_url();?>assets/assets/img/generic/card.png" alt="" /><span
                            class="label-text"> <?php echo lang('App.personalizacion.estilo.claro');?></span></label>
                </div>
                <div class="col-6">
                    ...
                    <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant"> <img
                            class="img-fluid img-prototype"
                            src="<?php echo base_url();?>assets/assets/img/generic/vibrant.png" alt="" /><span
                            class="label-text"> <?php echo lang('App.personalizacion.estilo.azul');?></span></label>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card-body d-flex align-items-center py-md-2 px-2 py-1">
        ...
        <small
            class="text-uppercase text-primary fw-bold bg-primary-subtle py-2 pe-2 ps-1 rounded-end"><?php echo lang('App.personalizacion.boton');?></small>
    </div>
</a>
