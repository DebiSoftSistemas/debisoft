                ...
                <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4"><a
                    ...
                    <div class="card">
                        <div class="card-body p-4 p-sm-5">
                            ...
                            <p class="lead mt-4 text-800 font-sans-serif fw-semi-bold w-md-75 w-xl-100 mx-auto"><?php echo lang('Error.500.titulo');?></p>
                            <hr />
                            <p><?php echo lang('Error.500.descripcion');?> <a href="mailto:<?php echo lang('App.general.correo');?>"
                                    class="text-rpimary">contáctanos</a>.</p><a class="btn btn-primary btn-sm mt-3"
