...
var wizardInit = function wizardInit() {
  ...
  wizards.forEach(function (wizard) {
    ...
    var emailPattern = inputEmail != null ? inputEmail.getAttribute('pattern') : '';
    ...
    var prevButton = wizard.querySelector('.previous');
    ...
    if(nextButton != null && prevButton != null){
      ...
      nextButton.addEventListener('click', function () {
        if (((inputEmail != null && !(inputEmail.value && validatePattern(emailPattern, inputEmail.value))) || (inputPassword != null && !inputPassword.value) || (inputConfirmPassword != null && !inputConfirmPassword.value)) && form.className.includes('needs-validation')) {
          form.classList.add('was-validated');
        } else {
          count += 1;
